  ...
  return (
    <FormProvider {...methods}>
      ...
      <label htmlFor="online" className={styles.order__payment__label}>
                        {(active === 'online') ? <MdOutlineRadioButtonChecked height='24px' width='24px' color='#196C67' /> : <MdOutlineRadioButtonUnchecked height='24px' width='24px' color='#959595' /> }
      <span className={styles.order__payment__label__text}>Оплата карткою Online</span>
                  ...
                  <label htmlFor="cash" className={styles.order__payment__label}>
                        {(active === 'cash') ? <MdOutlineRadioButtonChecked  height='24px' width='24px' color='#196C67' /> : <MdOutlineRadioButtonUnchecked height='24px' width='24px' color='#959595' /> }
                  <span className={styles.order__payment__label__text}>Готівкою або карткою: при отриманні</span>
                    </label>
                    <Controller
                        name="payment"
                        control={control}
