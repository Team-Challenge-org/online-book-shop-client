      ...
      <div className={styles.footer}>
        ...
        <div className={styles.footer__block}>
          ...
          <div className={styles.footer__block__text}>
            ...
            <Link to='tel:+380973333377' className={styles.footer__block__text__item__link}>
              +38 097 333 33 77
            </Link>
            <Link to='mailto:info@tcl.ua' className={styles.footer__block__text__item__link}>
              info@tcl.ua
            </Link>
          </div>
          <div className={styles.footer__block__social}>
            <h1 className={styles.footer__block__social__title}>Ми в соціальних мережах</h1>
        ...
        <div className={styles.footer__block}>
          ...
          <div className={styles.footer__block__text}>
            <Link to={NAV_URL.HOME_PAGE} className={styles.footer__block__text__item__link}>
              Про нас
            </Link>
            <Link to={NAV_URL.HOME_PAGE} className={styles.footer__block__text__item__link}>
              Оплата та доставка
            ...
            <Link to={NAV_URL.PRIVACY} className={styles.footer__block__text__item__link}>
